...
def register_nude(bot: commands.Bot):
    @bot.tree.command(name="nude", description="Gửi ảnh nude ngẫu nhiên (only: 🔞┊nsfw)")
    async def nude(interaction: discord.Interaction):
        ...
        try:
            ...
            with open("bot/url/nude", "r", encoding="utf-8") as f:
